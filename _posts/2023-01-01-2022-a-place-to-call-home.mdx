...
<div className="blog-img-wrapper">
  ...
  <div className="blog-img-wrapper__desc">
    Screenshots from{" "}
    <a
      href="https://apps.apple.com/gd/app/blocks-minimal-habit-tracker/id1550584642"
      target="_blank"
    >
      Blocks
    </a>{" "}
    and{" "}
    <a href="https://www.withings.com/uk/en/health-mate" target="_blank">
      Healthmate
    </a>
    , showing daily log of habits in 2022
  </div>
</div>
