...
<div className="blog-img-wrapper">
  <div className="columns-3 last-mb-0">
    <img
      src="/assets/images/posts/2024-01-01-2023-shifting-seasons/wedding-1.jpg"
      alt="Leaving the ceremony"
      className="rounded-xl mb-4"
    />
    <img
      src="/assets/images/posts/2024-01-01-2023-shifting-seasons/wedding-2.jpg"
      alt="Customary fam shot"
      className="rounded-xl mb-4"
    />
    <img
      src="/assets/images/posts/2024-01-01-2023-shifting-seasons/wedding-3.jpg"
      alt="First dance after surprise outfit change"
      className="rounded-xl mb-4"
    />
  </div>
  <div className="blog-img-wrapper__desc">A few photos from the big day</div>
</div>
...
<div className="blog-img-wrapper">
  <img
    src="/assets/images/posts/2024-01-01-2023-shifting-seasons/land.jpg"
    alt="Customary fam shot"
    className="rounded-xl mb-4"
  />
  <div className="blog-img-wrapper__desc">
    Lorna & I measuring out the plot last summer
  </div>
</div>
...
<div className="blog-img-wrapper">
  <div className="columns-3 last-mb-0">
    <img
      src="/assets/images/posts/2024-01-01-2023-shifting-seasons/health-1.png"
      alt="Workout stats for the year"
      className="rounded-xl mb-4"
    />
    <img
      src="/assets/images/posts/2024-01-01-2023-shifting-seasons/health-2.png"
      alt="Mood stats for the year"
      className="rounded-xl mb-4"
    />
    <img
      src="/assets/images/posts/2024-01-01-2023-shifting-seasons/health-3.png"
      alt="Body fat / muscle stats for the year"
      className="rounded-xl mb-4"
    />
  </div>
  <div className="blog-img-wrapper__desc">
    Some stats for the year from my app,{" "}
    <a
      href="https://twitter.com/blockshabits"
      rel="nofollow noreferrer"
      target="_blank"
    >
      Blocks
    </a>{" "}
    (workouts and body comp dropped off from the summer, read below for why)
  </div>
</div>
...
<div className="blog-img-wrapper">
  <div className="columns-3 last-mb-0">
    <img
      src="/assets/images/posts/2024-01-01-2023-shifting-seasons/devon-1.jpg"
      alt="Alleyway in Bideford"
      className="rounded-xl mb-4"
    />
    <img
      src="/assets/images/posts/2024-01-01-2023-shifting-seasons/devon-2.jpg"
      alt="Boat race in Bideford"
      className="rounded-xl mb-4"
    />
    <img
      src="/assets/images/posts/2024-01-01-2023-shifting-seasons/devon-3.jpg"
      alt="Narrow road in Bideford"
      className="rounded-xl mb-4"
    />
  </div>
  <div className="blog-img-wrapper__desc">
    A few shots from the summer trip to Cornwall
  </div>
</div>
...
<div className="blog-img-wrapper">
  <div className="columns-2 last-mb-0">
    <img
      src="/assets/images/posts/2024-01-01-2023-shifting-seasons/lake-district-1.jpg"
      alt="Boat race in Bideford"
      className="rounded-xl mb-4"
    />
    <img
      src="/assets/images/posts/2024-01-01-2023-shifting-seasons/lake-district-2.jpg"
      alt="Narrow road in Bideford"
      className="rounded-xl mb-4"
    />
  </div>
  <div className="blog-img-wrapper__desc">
    Countryside adventures in the Lake District
  </div>
</div>
...
<div className="blog-img-wrapper">
  <div className="columns-3 last-mb-0 mb-2">
    <img
      src="/assets/images/posts/2024-01-01-2023-shifting-seasons/norway-1.jpg"
      alt="Road in Bergen"
      className="rounded-xl mb-4"
    />
    <img
      src="/assets/images/posts/2024-01-01-2023-shifting-seasons/norway-2.jpg"
      alt="Cycling through Stavanger"
      className="rounded-xl mb-4"
    />
    <img
      src="/assets/images/posts/2024-01-01-2023-shifting-seasons/norway-3.jpg"
      alt="Northern Lights near Tromsø"
      className="rounded-xl mb-4"
    />
  </div>
  <div className="columns-2 last-mb-0">
    <img
      src="/assets/images/posts/2024-01-01-2023-shifting-seasons/norway-4.jpg"
      alt="Christmassy hotel lobby in Stavanger"
      className="rounded-xl mb-4"
    />
    <img
      src="/assets/images/posts/2024-01-01-2023-shifting-seasons/norway-5.jpg"
      alt="Cabin by a frozen lake near Tromsø"
      className="rounded-xl mb-4"
    />
  </div>
  <div className="blog-img-wrapper__desc">Some highlights from the honeymoon</div>
</div>
...
<div className="blog-img-wrapper">
  <div className="columns-3 last-mb-0">
    <img
      src="/assets/images/posts/2024-01-01-2023-shifting-seasons/edinburgh-1.jpg"
      alt="Reading Rest, whilst Watson rests at my feet"
      className="rounded-xl mb-4"
    />
    <img
      src="/assets/images/posts/2024-01-01-2023-shifting-seasons/edinburgh-2.jpg"
      alt="Watson in the snow"
      className="rounded-xl mb-4"
    />
    <img
      src="/assets/images/posts/2024-01-01-2023-shifting-seasons/edinburgh-3.jpg"
      alt="New years fireworks"
      className="rounded-xl mb-4"
    />
  </div>
  <div className="blog-img-wrapper__desc">It was a restful time up in Scotland</div>
</div>
