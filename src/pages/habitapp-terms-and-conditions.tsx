...
const HabitAppTermsAndConditions = () => (
  <Main
    className="max-w-prose"
    meta={
      <Meta
        title="Habit App Terms & Conditions"
        description="Terms and conditions for the habit app"
      />
    }
  >
    ...
    <p>
      ...
      intellectual property rights related to it, still belong to Fernoon
      Limited.
    </p>
    <p>
      Fernoon Limited is committed to ensuring that the app is as useful and
    ...
    <p>
      The HeyFrank app stores and processes personal data that you have provided
      ...
      features and it could mean that the HeyFrank app won’t work properly or at
      all.
    </p>
    <div>
      <p>
      ...
      <ul>
        ...
        <li>
          <a href="https://expo.io/terms" target="_blank" rel="noreferrer">
            Expo
          </a>
        </li>
      </ul>
    ...
    <p>
      You should be aware that there are certain things that Fernoon Limited
      ...
      be Wi-Fi, or provided by your mobile network provider, but Fernoon Limited
    ...
    <p>
      Along the same lines, Fernoon Limited cannot always take responsibility
      ...
      avail the Service, Fernoon Limited cannot accept responsibility.
    </p>
    <p>
      With respect to Fernoon Limited’s responsibility for your use of the app,
      ...
      available to you. Fernoon Limited accepts no liability for any loss,
    ...
    <p>
      ...
      Fernoon Limited does not promise that it will always update the app so
    ...
    <p>These terms and conditions are effective as of 2020-05-04</p>
    <p>
      <strong>Contact Us</strong>
    </p>
    <p>
      If you have any questions or suggestions about our Terms and Conditions,
      do not hesitate to contact us at fred@fredrivett.com.
    </p>
    <p>
...
export default HabitAppTermsAndConditions;
