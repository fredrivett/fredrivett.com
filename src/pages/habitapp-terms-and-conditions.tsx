...
const HabitAppTermsAndConditions = () => (
  ...
  >
    <Container maxWidth="prose">
      ...
      <p>
        The HeyFrank app stores and processes personal data that you have
        ...
        phone’s security features and it could mean that the HeyFrank app won’t
      ...
      <p>
        ...
        can be Wi-Fi, or provided by your mobile network provider, but Fernoon
        Limited cannot take responsibility for the app not working at full
      ...
      <p>
        With respect to Fernoon Limited’s responsibility for your use of the
        ...
        we can make it available to you. Fernoon Limited accepts no liability
      ...
      <p>
        ...
        app. Fernoon Limited does not promise that it will always update the app
