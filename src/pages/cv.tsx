              ...
              <div className="p-6 lg:w-2/5 print:order-2 print:w-full">
                ...
                <div className="flex flex-col gap-3 border-l-4 border-gray-300 dark:border-gray-800 lg:border-l-0 pl-4 lg:pl-0 mb-8 lg:mb-0">
                  ...
                  >
                    Fred is{" "}
                    <strong>
                      not only an extremely skilled front-end engineer, he’s got
                      a talent for design, good product instincts, and most
                      importantly, he deeply cares.
                    </strong>{" "}
                    He wants to get it right, and{" "}
                    <strong>he works incredibly hard to do so</strong>. I hope
                    I’m lucky enough to be able to work with him again one day
                    soon!
                  </Testimonial>
                  <Testimonial
                    cite={
                  ...
                  >
                    Fred is a{" "}
                    <strong>
                      talented engineer with a strong product focus; a pleasure
                      to work with.
                    </strong>
                  </Testimonial>
                  <Testimonial
                  ...
                  >
                    <strong>
                      ...
                      time I have a front end contract that needs a safe, grown
                      up pair of hands to really get in and deliver, he&apos;s
                      the guy.
                    </strong>{" "}
                    I know I can match him to any client and they will be
                    grateful having had him on their project. I would recommend
                    him for any gig, but especially those where you just need a
                    really nice personable human to come in, get stuff done, and
                    be really cool to work with.{" "}
                    <strong>
                  ...
                  >
                    We hired Fred roughly nine months ago to develop the
                    frontend component of a larger application that we are
                    developing for an internal client. During this time,{" "}
                    <strong>
                    ...
                    projects. He then built out the entire vision for the
                    product on a very short timeline.
                    <br />
                    <br />
                    ...
                    entire effort. In terms of project management, Fred
                    integrated naturally into our team’s agile process and was
                    very meticulous in tracking the work and keeping the tools
                    up to date.
                    <br />
                    <br />
                    Fred has been a pleasure to work with and has worked
                    extremely well with the entire rest of our team. Fred
                    exemplified all of the values that we look for on our team,
                    including competence, meticulousness, humility, and a desire
                    to do things correctly.{" "}
                    <strong>
                      I would love to work with Fred again, and I highly
                      recommend him to anyone looking for an experienced
                      frontend developer.
                    </strong>
                  </Testimonial>
                  <Testimonial
                  ...
                  >
                    ...
                    number of his own products to market, has a deep
                    understanding of the full product lifecycle. He is always
                    thinking about what the customer wants and how to deliver
                    the best value.{" "}
                    <strong>
                    ...
                    extremely quickly. For example, on the first project we
                    worked on together, he had never worked with Ruby on Rails,
                    but was able to quickly learn enough to collaborate with the
                    backend engineers, and even write some backend Ruby code
                    himself.{" "}
                    <strong>
                      Fred has strong collaboration skills and is a fantastic
                      team player.
                    </strong>{" "}
                  ...
                  >
                    <strong>
                      This is the second time I have worked with Fred and
                      I&apos;m hoping there will be a third, and a
                      fourth&hellip;
                    </strong>{" "}
                    ...
                    <strong>
                      I seriously doubt our project would have been so
                      successful without his work.
                    </strong>
                  </Testimonial>
                </div>
              </div>
