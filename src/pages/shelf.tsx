    ...
    items: [
      {
        ...
        by: "Richard Rohr",
        description:
          "A remarkable book about the two halves of life. Marmite, if it's for you, it's for you.",
  ...
  >
    <Container maxWidth="md">
      <div className="mb-8">
        ...
        <h1 className="fs-0 mb-1 leading-none">On my shelf</h1>
        <p className="mb-4">
          If I had to only have a few things to return to and lend to friends,
          these would be on it. Some of the threads of my tapestry.
        </p>
        <p className="opacity-50">
          <em>Updated: {format(new Date("2025-01-09"), "do MMMM yyyy")}</em>
        </p>
      </div>
    </Container>
    ...
    <div className="px-6">
      ...
      >
        {Object.entries(sections).map(([key, section]) => (
          <div
            key={key}
            className="flex-1 min-w-[280px] max-w-[400px] space-y-4"
          >
